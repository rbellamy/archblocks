...
MNT=/mnt; TMP=/tmp/archblocks; POSTCHROOT="/post-chroot"; POSTSCRIPT="${POSTCHROOT}.sh"; POSTSCRIPTLOG="${POSTCHROOT}.log";
...
_defaultvalue HOOKS "base udev autodetect block keyboard filesystems fsck"
